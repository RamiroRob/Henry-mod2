...
describe("04 | Ejercicios", () => {
  it('mapStateToProps debería retornar la propiedad "list" del estado de redux', () => {
    const state = {
      list: [
        { name: "Manzanas", price: 321, id: 1 },
        { name: "Peras", price: 203, id: 2 },
      ],
    };
    // Primera prueba
  ...
  it("Products debería renderizar una Card por cada elemento de la lista recibida por props y asignar las props correspondientes", () => {
    const list = [
      { name: "Uvas", price: 321, id: 1 },
      { name: "Naranjas", price: 203, id: 2 },
      { name: "Tomates", price: 103, id: 3 },
    ];
    const products = shallow(<Products list={list} />);
